/**
 * bconnect-universaldynamicgroups-mcp — finding A2 / INT-53 regression: ONE error prefix, not two.
 *
...
describe('bconnect-universaldynamicgroups-mcp — error message carries one MCP prefix', () => {
  ...
  it('invalid arguments: -32602 is prefixed exactly once', async () => {
    const error = await callAndCatch('get_universal_dynamic_group', { id: 'not-a-guid' });
