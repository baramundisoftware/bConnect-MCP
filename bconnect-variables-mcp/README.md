...
**Tools:** 9 by default (13 with `ALLOW_WRITE_OPERATIONS=true`)
...
node --env-file=/path/to/bconnect.env bconnect-variables-mcp/build/index.js
```
...
```json
{
  "bconnect-variables": {
    ...
    "args": [
      ...
      "/opt/bconnect-mcp-suite/bconnect-variables-mcp/build/index.js"
    ]
  }
}
```
