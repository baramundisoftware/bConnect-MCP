...
/**
 * Assets API Validation Rules
 */
export const AssetsRules = {
  // GET /Assets
  listAssets: (): ValidationRule[] => paginationRules(),

  // GET /Assets/{id}
  getAsset: (): ValidationRule[] => [
    CommonRules.guid('assetId')
  ],

  // GET /AssetTypes
  listAssetTypes: (): ValidationRule[] => paginationRules(),

  // GET /AssetTypes/{id}
  getAssetType: (): ValidationRule[] => [
    CommonRules.guid('id')
  ],
  ...
  // DELETE /Assets/{id}
  deleteAsset: (): ValidationRule[] => [
    CommonRules.guid('assetId')
  ],

  // POST /AssetStockFolders
  createAssetStockFolder: (): ValidationRule[] => [
    {
      name: 'name',
      required: true,
      type: 'string',
    ...
    CommonRules.guidOptional('parentFolderId')
  ],

  // PATCH /AssetStockFolders/{id}
  updateAssetStockFolder: (): ValidationRule[] => [
    CommonRules.guid('id'),
    {
      name: 'name',
      required: false,
  ...
  // DELETE /AssetStockFolders/{id}
  deleteAssetStockFolder: (): ValidationRule[] => [
    CommonRules.guid('id')
  ],

  // POST /AssetTypeFolders
  createAssetTypeFolder: (): ValidationRule[] => [
    {
      name: 'name',
      required: true,
      type: 'string',
  ...
  // PATCH /AssetTypeFolders/{id}
  updateAssetTypeFolder: (): ValidationRule[] => [
    CommonRules.guid('id'),
    {
      name: 'name',
      required: false,
  ...
  // DELETE /AssetTypeFolders/{id}
  deleteAssetTypeFolder: (): ValidationRule[] => [
    CommonRules.guid('id')
  ]
};
...
export function validateToolParameters(
  ...
  switch (toolName) {
    ...
    case 'list_asset_stock_folders':
      return validateOrThrow(args, AssetsRules.listAssets());
    case 'get_asset':
      return validateOrThrow(args, AssetsRules.getAsset());
    case 'list_asset_types':
      return validateOrThrow(args, AssetsRules.listAssetTypes());
    case 'get_asset_type':
      return validateOrThrow(args, AssetsRules.getAssetType());
    case 'list_assets_by_endpoint':
      return validateOrThrow(args, AssetsRules.listAssets());
    case 'create_asset':
      return validateOrThrow(args, AssetsRules.createAsset());
    case 'update_asset':
      return validateOrThrow(args, AssetsRules.updateAsset());
    case 'delete_asset':
      return validateOrThrow(args, AssetsRules.deleteAsset());
    case 'create_asset_type':
    case 'delete_asset_type':
      return validateOrThrow(args, AssetsRules.getAssetType());
    case 'create_asset_stock_folder':
      return validateOrThrow(args, AssetsRules.createAssetStockFolder());
    case 'update_asset_stock_folder':
      return validateOrThrow(args, AssetsRules.updateAssetStockFolder());
    case 'delete_asset_stock_folder':
      return validateOrThrow(args, AssetsRules.deleteAssetStockFolder());
    case 'create_asset_type_folder':
      return validateOrThrow(args, AssetsRules.createAssetTypeFolder());
    case 'update_asset_type_folder':
      return validateOrThrow(args, AssetsRules.updateAssetTypeFolder());
    case 'delete_asset_type_folder':
      return validateOrThrow(args, AssetsRules.deleteAssetTypeFolder());
