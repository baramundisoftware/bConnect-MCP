# Docker Deployment Guide — bConnect MCP Suite 26.1.0
...
docker build -t bconnect-activedirectory-mcp:26.1.0 ./bconnect-activedirectory-mcp
  ...
  "mcpServers": {
    "bconnect-activedirectory": {
      ...
      "args": [
        ...
        "bconnect-activedirectory-mcp:26.1.0"
      ]
    }
  }
}
