...
export class EndpointsModule {
   ...
   */
  async createWindowsEndpoint(endpointData: any): Promise<any> {
   ...
   */
  async updateWindowsEndpoint(id: string, updateData: any): Promise<any> {
   ...
   */
  async startWindowsEndpointEnrollment(id: string, enrollmentData?: any): Promise<void> {
   ...
   */
  async createLinuxEndpoint(endpointData: any): Promise<any> {
    const response = await this.client.post(
      `${this.basePath}/LinuxEndpoints`,
      endpointData
    );
   ...
   */
  async updateLinuxEndpoint(id: string, updateData: any): Promise<any> {
    const response = await this.client.patch(
      `${this.basePath}/LinuxEndpoints/${id}`,
      updateData
    );
   ...
   */
  async createMacEndpoint(endpointData: any): Promise<any> {
    const response = await this.client.post(
      `${this.basePath}/MacEndpoints`,
      endpointData
    );
   ...
   */
  async updateMacEndpoint(id: string, updateData: any): Promise<any> {
    const response = await this.client.patch(
      `${this.basePath}/MacEndpoints/${id}`,
      updateData
    );
   ...
   */
  async startMacEndpointEnrollment(id: string, enrollmentData?: any): Promise<void> {
    await this.client.post(
   ...
   */
  async createLogicalGroup(groupData: any): Promise<any> {
    const response = await this.client.post(
      `${this.basePath}/LogicalGroups`,
      groupData
    );
   ...
   */
  async updateLogicalGroup(id: string, updateData: any): Promise<any> {
    const response = await this.client.patch(
      `${this.basePath}/LogicalGroups/${id}`,
      updateData
    );
