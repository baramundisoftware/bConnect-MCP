 ...
 * Every composite in this server issues multi-page walks with no overall
 * deadline. `BCONNECT_TIMEOUT_MS` bounds one REQUEST; a walk of several hundred
 * requests has no bound at all. The MCP host is the one holding a clock — every
