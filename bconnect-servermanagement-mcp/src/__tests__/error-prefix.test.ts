/**
 * bconnect-servermanagement-mcp — finding A2 / INT-53 regression: ONE error prefix, not two.
 *
...
describe('bconnect-servermanagement-mcp — error message carries one MCP prefix', () => {
  ...
  it('invalid arguments: -32602 is prefixed exactly once', async () => {
    const error = await callAndCatch('get_microservice', {});
