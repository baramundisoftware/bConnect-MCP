...
**Tools:** 5 by default (9 with `ALLOW_WRITE_OPERATIONS=true`)
...
npm run build -w bconnect-operatingsystems-mcp

# Run it. Credentials come from the env file, never from the command line.
node --env-file=/path/to/bconnect.env bconnect-operatingsystems-mcp/build/index.js
```
...
```json
{
  "bconnect-operatingsystems": {
    ...
    "args": [
      ...
      "/opt/bconnect-mcp-suite/bconnect-operatingsystems-mcp/build/index.js"
    ]
  }
}
```
