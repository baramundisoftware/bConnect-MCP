/**
 * bconnect-endpoints-mcp — finding A2 / INT-53 regression: ONE error prefix, not two.
 *
...
describe('bconnect-endpoints-mcp — error message carries one MCP prefix', () => {
  ...
  it('invalid arguments: -32602 is prefixed exactly once', async () => {
    const error = await callAndCatch('list_endpoints', { bogusFilter: 1 });
