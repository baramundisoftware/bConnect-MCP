    ...
    try {
      ...
      switch (name) {
        ...
        case "get_entra_id_data": {
          ...
          validateOrThrow(args, EndpointsRules.getByEndpointId());
        ...
        case "link_entra_id_data": {
          ...
          validateOrThrow(args, EndpointsRules.linkEntraIdData());
...
async function main() {
  ...
  console.error("bconnect-endpoints-mcp server running on stdio");
}
