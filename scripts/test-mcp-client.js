...
const server = spawn('node', ['build/index.js'], {
  ...
  env: {
    ...process.env,
    BCONNECT_BASE_URL: process.env.BCONNECT_BASE_URL || (() => { throw new Error('Set BCONNECT_BASE_URL'); })(),
    BCONNECT_USERNAME: process.env.BCONNECT_USERNAME || (() => { throw new Error('Set BCONNECT_USERNAME'); })(),
    BCONNECT_PASSWORD: process.env.BCONNECT_PASSWORD || (() => { throw new Error('Set BCONNECT_PASSWORD'); })(),
